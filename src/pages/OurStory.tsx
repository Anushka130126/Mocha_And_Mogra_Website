...
export default function OurStory() {
  ...
  return (
    <div className="pt-24 pb-0">
      ...
      >
        <img
          src="https://res.cloudinary.com/xtrw55ut/image/upload/v1/MnM/modelslandscape.webp"
      ...
      <div className="flex justify-center mb-24">
        <div className="flex items-center gap-4">
          ...
          <img src="https://res.cloudinary.com/xtrw55ut/image/upload/v1/MnM/mnmlogo-Photoroom.webp" alt="" className="h-8 w-8 object-contain opacity-40" loading="lazy" />
          <div className="w-16 h-px bg-mocha-300" />
        </div>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 mb-28">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <img
              src="https://res.cloudinary.com/xtrw55ut/image/upload/v1/MnM/modelwalkinginriwaayat.webp"
              alt="The Founder"
      ...
      <section className="bg-mocha-900 py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <img
                src="https://res.cloudinary.com/xtrw55ut/image/upload/v1/MnM/machine.jpg"
