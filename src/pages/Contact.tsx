    ...
    <div className="pt-24 pb-20 min-h-screen">
      ...
      <div className="mt-24 grid grid-cols-3 gap-1 overflow-hidden">
        {[
          ...
          'https://res.cloudinary.com/xtrw55ut/image/upload/q_auto,f_auto,w_800/bm4.webp',
          'https://res.cloudinary.com/xtrw55ut/image/upload/q_auto,f_auto,w_800/rd3.webp',
        ].map((src, i) => (
