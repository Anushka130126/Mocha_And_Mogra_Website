  ...
  return (
    <div className="pt-24 pb-20 min-h-screen">
      ...
      <div className="mt-24 grid grid-cols-3 gap-1 overflow-hidden">
        {[
          'https://res.cloudinary.com/xtrw55ut/image/upload/jp1.webp',
          'https://res.cloudinary.com/xtrw55ut/image/upload/multisareepic.webp',
          'https://res.cloudinary.com/xtrw55ut/image/upload/coverpiccloseup.webp',
        ].map((src, i) => (
