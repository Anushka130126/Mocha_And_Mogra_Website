  ...
  return (
    <div className="pt-24 pb-20 min-h-screen flex items-center">
      <div className="max-w-2xl mx-auto px-6 text-center w-full">
        ...
        >
          {[
            'https://res.cloudinary.com/xtrw55ut/image/upload/MnM/ruby_doe.webp',
            'https://res.cloudinary.com/xtrw55ut/image/upload/MnM/butter_mogra.webp',
            'https://res.cloudinary.com/xtrw55ut/image/upload/MnM/sundowner_silk.webp',
          ].map((src, i) => (
            <div
              key={i}
