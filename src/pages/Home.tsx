          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              <div className="relative w-full max-w-sm">
                ...
                >
                  <video
                    src="https://res.cloudinary.com/xtrw55ut/video/upload/v1/MnM/coverreel1.webm"
            ...
            <div className="lg:col-span-7 grid grid-cols-3 gap-2 md:gap-4 lg:gap-6 w-full">
              ...
              <div className="flex flex-col mt-16 md:mt-24 lg:mt-32">
                ...
                >
                  {teaserInView && (
                    <video
                      src="https://res.cloudinary.com/xtrw55ut/video/upload/v1/MnM/coverreel2.webm"
                      className="absolute top-1/2 left-1/2 max-w-none"
              ...
              <div className="flex flex-col mt-0">
                ...
                >
                  {teaserInView && (
                    <video
                      src="https://res.cloudinary.com/xtrw55ut/video/upload/v1/MnM/sm2.webm"
              ...
              <div className="flex flex-col mt-16 md:mt-24 lg:mt-32">
                ...
                >
                  {teaserInView && (
                    <video
                      src="https://res.cloudinary.com/xtrw55ut/video/upload/v1/MnM/coverreel3.webm"
                      className="absolute top-1/2 left-1/2 max-w-none"
                      style={{ width: '177.77%', height: '56.25%', transform: 'translate(-50%, -50%) rotate(-90deg)' }}
                      autoPlay
                      muted
